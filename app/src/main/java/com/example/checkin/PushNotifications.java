...
public class PushNotifications extends FirebaseMessagingService {
    ...
    /**
     * Called when a new token for the Firebase Cloud Messaging service is generated.
     *
    ...
    /**
     * Called when a new notification message is received.
     *
    ...
    /**
     * Displays a milestone notification when the attendee count reaches a milestone.
     *
     * @param title The title of the milestone notification.
     * @param body  The body/content of the milestone notification.
     */
    ...
    /**
     * Checks if a received message is a milestone notification.
     *
     * @param message The message received from Firebase Cloud Messaging.
     * @return True if the message is a milestone notification, false otherwise.
     */
    ...
    /**
     * Checks if the attendee count has reached a milestone and displays a milestone notification if so.
     *
     * @param attendeeCount The current attendee count.
     */
